...
| **[Todo List](https://github.com/waleedtarbosh/todo-list)** | A task management and to-do list application. | JavaScript, HTML, CSS | [Source Code](https://github.com/waleedtarbosh/todo-list) |
